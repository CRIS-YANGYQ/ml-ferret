...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default="/comp_robot/liushilong/data/coco")
    parser.add_argument("--json_path", type=str, default="/comp_robot/liushilong/data/coco/annotations/lvis_v1_minival_inserted_image_name_modify_catname.json")
